...
import Multiplayer.PyromancerClient;
...
public class Player implements Serializable, Comparator<Player> {
    ...
    public transient ArrayList<Potion> placedBombs;
    public transient BombGameManager bm;
    public transient Animation up, down, left, right;
    ...
    {
        up = animations.get(0);
        down = animations.get(1);
        left = animations.get(2);
        right = animations.get(3);
    }
