...
//                            al.add(t); 
    ...
    public void init(GameContainer gc) throws SlickException {
        ...
        BGM = new BombGameManager(players, powerUps, 15);
        ...
        for (int i = 0; i < playernames.size(); i++) {
            switch (i) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    players.add(new Player(2, playernames.get(i), 1, 13, 0, 0, 255, BGM));
                    break;
                case 3:
                    players.add(new Player(3, playernames.get(i), 1, 13, 110, 0, 255, BGM));
                    break;
            }
        }
        ...
        players.get(0).powerUpCanKick = true;
    ...
    class ClientThread extends Thread {
        ...
        ClientThread(Socket socket) {
            ...
            try {
                ...
                timer.scheduleAtFixedRate(new ClientThread.TellClient(), 0, 200);
        ...
        public class TellClient extends TimerTask {
            ...
            public void run() {
                ...
                try {
                    ...
                    synchronized (BGM.activePlayers) {
                        GDTC.allPlayers = BGM.activePlayers;
                        BGM.checkBombVictims();
                    }
                    synchronized (BGM.allActivePotions) {
                        GDTC.allPotions = BGM.allActivePotions;
                    }
                    synchronized (BGM.allPowerUps) {
                        GDTC.allPowerUps = BGM.allPowerUps;
                    }
                    synchronized (BGM.spawned_boxes) {
                        GDTC.allBoxes = BGM.spawned_boxes;
                    }
                    synchronized (GDTC) {
                        //synchronized
        ...
        private boolean writeState() throws IOException {
